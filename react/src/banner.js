    ...
    <div className="body-style">
      <form method="post" id="iform" className="form">
        ...
        <div className="editor-settings">
          ...
          <input
            type="text"
            id="ename"
            placeholder="Enter an Editor's Name"
            name="ename"
            required
            minLength="4"
            maxLength="16"
        ...
        <div className="ebtns-container">
          <button id="add" class="export-buttons" type="submit">
            {" "}
            Add User
          </button>
          <button class="export-buttons" type="button">
            Remove
          </button>
          <button class="export-buttons" type="button">
            Remove All
      ...
      <div className="ebtns-container">
        ...
        >
          ...
          <button class="export-buttons" type="submit">
            Import
          </button>
        </form>
      </div>
