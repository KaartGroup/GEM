...
#################################################################################
    def retranslateUi(self,MAINWindow):
        ...
        self.GUMarray =[[str(''),str(''),str(''),str(''),str('')] for j in range(self.GUMrowcount)]
...
#############
    ...
    def GITPUSH_GO(self):
        ...
        self.repo.update_file(self.contents.path, "TEST", self.OUTPUSHTEXT, self.contents.sha)
...
#######################################################GUM INTERFACE#############################################
        ...
        if MOVETO != int(-1):
          ...
          if str(MOVETO) in self.GUMTEMPUSERS.keys():
            if  self.GUMTEMPUSERS[str(MOVETO)] == 0:
                ...
                self.GUMarray[(MOVETO)][1] = self.GUMTEMPUSERS[str(MOVEFROM)].USERNAME
                self.GUMarray[(MOVETO)][2] = self.GUMTEMPUSERS[str(MOVEFROM)].UID
                self.GUMarray[(MOVETO)][3] = self.GUMTEMPUSERS[str(MOVEFROM)].TITLE
                self.GUMarray[(MOVETO)][4] = self.GUMTEMPUSERS[str(MOVEFROM)].GITACCESSTEXT
    ...
    def GUMEXPORT_clicked(self):
        ...
        for i in self.GUMADDUSERS:
            ...
            if self.GUMOUTUSERS == self.GUMusercount:
                self.GUMLASTUSERENTRY(i.TITLE, i.NAME,i.USERNAME,str(i.GITACCESS),i.UID)
            else:
        ...
        if self.repoGO != False:
            self.repo.update_file(self.contents.path, "TEST", self.GUMMASTERENTRYTEXT, self.contents.sha)
        else:
    ...
    def GUMLASTUSERENTRY(self,title,name,username,access,uid):
       self.GUMUSERENTRYBLOCK += ( """      {
         ...
         "gitaccess":"%s",
         "uid": "%s"
      }"""%(title,name,username,access,uid))
   ...
   "USERS": [
    ...
    def GUMADD_clicked(self):
        ...
        if self.GUMSELECT != '':
           if self.GUMEDITORNAME.text() != "":
            ...
            self.GUMarray[self.GUMSELECT][0]=str(self.GUMTEMPUSERS[str(self.GUMSELECT)].NAME)
            self.GUMarray[self.GUMSELECT][1]=str(self.GUMTEMPUSERS[str(self.GUMSELECT)].USERNAME)
            self.GUMarray[self.GUMSELECT][2]=str(self.GUMTEMPUSERS[str(self.GUMSELECT)].UID)
            self.GUMarray[self.GUMSELECT][3]=str(self.GUMTEMPUSERS[str(self.GUMSELECT)].TITLE)
            self.GUMarray[self.GUMSELECT][4]=str(self.GUMTEMPUSERS[str(self.GUMSELECT)].GITACCESSTEXT)
    ...
    def GUMEDIT_clicked(self):
      try:
        ...
        self.GUMEDITORUSERNAME.setText(self.GUMTEMPUSERS[str(self.GUMSELECT)].USERNAME)
